...
from aiapi.sqlite import delete_expired_auth_tokens, get_countdown_timer_deadline, is_sqlite_ready_for_app
...
st.set_page_config(page_title="Golf Streamlit", page_icon="assets/vo_logo_rounded.png", layout="wide")
apply_global_styles()
...
from ui.components.html_visuals import render_countdown_timer

countdown_deadline = get_countdown_timer_deadline() or DEFAULT_COUNTDOWN_TIMER_DEADLINE
render_countdown_timer(countdown_deadline, label="Nedtelling")
